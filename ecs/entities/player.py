    ...
    def __init__(self, world, new_character=True, class_directive=None):
        if new_character and class_directive is not None:
            ...
            try:
                ...
                world.add_component(self.metadata.entity_id, Stats(stats[0], stats[1], stats[2], stats[3], stats[4], stats[5]))
                ...
                world.add_component(self.metadata.entity_id, Actor(stats[1]/2, True))
